...
def generate_cifar10(dir_path, num_clients, num_labels, class_per_client, niid=False, real=True, partition=None):
    ...
    dir_path_for_task = os.path.join(dir_path, f'{num_clients}_{class_per_client}')
